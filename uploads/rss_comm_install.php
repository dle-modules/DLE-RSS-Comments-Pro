...
'rss_not_news_id' => 'no',</textarea> 
		...
		<li>
			Открыть файл <b class="red">main.tpl</b> вашего шаблона. <br>Перед тегом <b class="red">{headers}</b> вставить:
			<textarea readonly>{include file="engine/modules/rss_comm.php"}</textarea>
			Это нужно для вывода метатега со ссылкой на RSS ленту комментариев.
		</li>
...
<head>
	...
	<style>
		...
		body{width: 800px; padding: 20px;margin: 20px auto;font:normal 14px/18px Arial, Helvetica, sans-serif;background: #f1f1f1;box-shadow: 0 0 15px 0 rgba(0, 0, 0, 0.1);color: #34495e;}
